class AccessionDisplayNamesSubreport < AbstractSubreport
  ...
  def query_string
    ...
    where accession_id = #{db.literal(@accession_id)}
      and (name_person.is_display_name or name_corporate_entity.is_display_name or name_family.is_display_name)"
  end
